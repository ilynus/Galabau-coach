...
st.divider()
if st.button('🃏 Lerneinheit abschließen (+15 Punkte)', use_container_width=True):
    add_event(user['id'], 'flashcard_session')
    st.success('Stark! Lerneinheit abgeschlossen. +15 Punkte')
